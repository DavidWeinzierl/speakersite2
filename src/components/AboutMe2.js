...
const AboutMe2 = () => {
  ...
  return (
    <>
      ...
      >
        {/* Parallax image - anchored near bottom, parallax-controlled */}
        <img
          ref={imgRef}
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3 pt-4 border-t border-gray-200/50 mt-2">
              ...
              <div className="flex gap-2">
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@philyourvoice"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-pink-500 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:rotate-6 shadow-md"
                  aria-label="TikTok"
                >
                  <img
    ...
    style={{ zIndex: 1 }}
      ...
      {/* Separate mobile-only section for the About Me bubble, below polygons */}
      <section className="md:hidden px-6 mt-6">
        <div
          className="bg-white/90 backdrop-blur rounded-2xl px-5 py-5 shadow-xl border border-gray-200"
          ...
          <div className="flex items-center justify-between gap-3 pt-3 border-t border-gray-200">
            <div className="flex gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center text-white"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-gradient-to-br from-cyan-400 to-pink-500 rounded-full flex items-center justify-center text-white"
                aria-label="TikTok"
              >
                <img
                  src={process.env.PUBLIC_URL + '/images/tiktokicon.png'}
            ...
            <a
              href="#contact"
              className="px-4 py-2 bg-primary-600 text-white rounded-full text-sm font-semibold"
            >
              Kontakt
            </a>
          </div>
