            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              {submitStatus === 'error' && (
                <div className="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-11h2v5h-2V7zm0 6h2v2h-2v-2z" />
                  </svg>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-lg font-medium">Schnell und zuverlässig</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-semibold opacity-90 mb-1">Telefon</p>
                    <a href="tel:+436642423725" className="text-lg font-medium hover:underline">+43 664 2423725</a>
                  </div>
                </div>
